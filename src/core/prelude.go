...
var compPrim = compiledPrimitives{
	...
	GmCompiledSC{"mul", 2, GmCode{Push(1), Eval{}, Push(1), Eval{}, Mul{}, Update(2), Pop(2), Unwind{}}},
	GmCompiledSC{"mod", 2, GmCode{Push(1), Eval{}, Push(1), Eval{}, Mod{}, Update(2), Pop(2), Unwind{}}},
	...
	GmCompiledSC{"lt", 2, GmCode{Push(1), Eval{}, Push(1), Eval{}, Lt{}, Update(2), Pop(2), Unwind{}}},
	// GmCompiledSC{"<=", 2, GmCode{Push(1), Eval{}, Push(1), Eval{}, Le{}, Update(2), Pop(2), Unwind{}}},
	GmCompiledSC{"gt", 2, GmCode{Push(1), Eval{}, Push(1), Eval{}, Gt{}, Update(2), Pop(2), Unwind{}}},
