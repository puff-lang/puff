...
var lexTests = []lexTest{
	...
	{"logical OR", "a || b", []token.Token{
		token.NewToken(token.IDENT, 0, "a"),
		token.NewToken(token.LOR, 0, "||"),
		token.NewToken(token.IDENT, 0, "b"),
		tEOF,
	}},
	{"logical OR", "n == 1 || n == 2", []token.Token{
		token.NewToken(token.IDENT, 0, "n"),
		token.NewToken(token.EQL, 0, "=="),
	...
	{"expression without spaces", "let x=3, y=2 in (x*x)+(y*y)", []token.Token{
		token.NewToken(token.LET, 0, "let"),
		token.NewToken(token.IDENT, 0, "x"),
		token.NewToken(token.ASSIGN, 0, "="),
		token.NewToken(token.INT, 0, "3"),
		token.NewToken(token.COMMA, 0, ","),
		token.NewToken(token.IDENT, 0, "y"),
		token.NewToken(token.ASSIGN, 0, "="),
		token.NewToken(token.INT, 0, "2"),
		token.NewToken(token.IN, 0, "in"),
		token.NewToken(token.LPAREN, 0, "("),
		token.NewToken(token.IDENT, 0, "x"),
		token.NewToken(token.MUL, 0, "*"),
		token.NewToken(token.IDENT, 0, "x"),
		token.NewToken(token.RPAREN, 0, ")"),
		token.NewToken(token.ADD, 0, "+"),
		token.NewToken(token.LPAREN, 0, "("),
		token.NewToken(token.IDENT, 0, "y"),
		token.NewToken(token.MUL, 0, "*"),
